...
KEEP USUBJID TBD AESTDTC AEENDTC AESER AEACN AEREL AEOUT;
...
TITLE3 J=C "Listing 16.2.1 Adverse Events";
 
footnote1 j=L "Source: &_SASPROGRAMFILE" j=R "Date: &sysdate9."; 

ODS ESCAPECHAR= "^";

proc report data=AE_LIST_02 split='*' missing nocenter headskip

style = {outputwidth= 100%};
COLUMN PAG USUBJID TBD AESTDTC AEENDTC AESER AEACN AEREL AEOUT ;
